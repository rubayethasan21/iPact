class AssetConstants {
  ...
  static const icLogoWithText1 = "${basePathIcons}ic_logo_with_text.svg";
  static const icLogoWithText = "${basePathIcons}ic_logo_with_text.png";
  static const ic_logo_horizontal = "${basePathIcons}ic_logo_horizontal.svg";
  static const icOnlyLogoText = "${basePathIcons}ic_only_logo_text.png";
  static const icCheckLarge ="${basePathIcons}ic_check_large.svg";
  static const icFolder ="${basePathIcons}ic_folder.svg";
  static const icDocuments ="${basePathIcons}ic_documents.svg";
  static const icStartNewCollaboration ="${basePathIcons}start_new_collaboration.svg";
  static const icSettings ="${basePathIcons}ic_settings.svg";
  static const icLocked ="${basePathIcons}ic_locked.svg";
  ...
  static const icFileChecked = "${basePathIcons}ic_file_checked.svg";
  static const icFileChecked2 = "${basePathIcons}ic_file_checked2.svg";
  static const icFileCross = "${basePathIcons}ic_file_cross.svg";
  static const icProfile = "${basePathIcons}ic_profile.svg";
  static const icFileUpload = "${basePathIcons}ic_file_upload.svg";
  static const icProfileMen = "${basePathIcons}ic_profile_men.svg";
  static const ic_setting = "${basePathIcons}ic_setting.svg";
  ...
  static const generatedMnemonic = "";
}
