...
class EncryptionController extends GetxController {
  ...
  Future<void> generateRsaKeyPairPemFile() async {
    final appSupportDir = await getApplicationSupportDirectory();
    //generateKeyPemFile('${appSupportDir.path}/cryptographic_documents/asymmetric_key_pairs/asymmetric_key_pair_1/',updateFlag:true);
    generateKeyPemFile('${appSupportDir.path}/cryptographic_documents/asymmetric_key_pairs/asymmetric_key_pair_1/');
    ...
    */
    /*symmetricEncryptFile(
        '${appSupportDir.path}/cryptographic_documents/symmetric_keys/symmetric_key_1.key',
    ...
    */
    /*asymmetricEncryptFile(
        ...
        '${appSupportDir.path}/cryptographic_documents/level_1_encrypted_files/level_1_encrypted_file_1.enc',
        '${appSupportDir.path}/cryptographic_documents/level_2_encrypted_files/',
        'level_2_encrypted_file_1.enc'
    );*/
    ...
    */
    /*asymmetricDecryptFile(
        ...
        '${appSupportDir.path}/cryptographic_documents/level_2_encrypted_files/level_2_encrypted_file_1.enc',
        '${appSupportDir.path}/cryptographic_documents/level_2_decrypted_files/',
        'level_2_decrypted_file_1.enc'
    );*/
    /*
    level 1 decryption
    */
   /* symmetricDecryptFile(
        '${appSupportDir.path}/cryptographic_documents/symmetric_keys/symmetric_key_1.key',
        '${appSupportDir.path}/cryptographic_documents/level_2_decrypted_files/level_2_decrypted_file_1.enc',
        '${appSupportDir.path}/cryptographic_documents/level_1_decrypted_files/',
        'level_1_decrypted_file_1.txt'
    );*/

    // var originalFileHash = await createHashFromFile(
    //     '${appSupportDir.path}/cryptographic_documents/original_files/original_file_1.txt');
    // var level1DecryptedFileHash = await createHashFromFile(
    //     '${appSupportDir.path}/cryptographic_documents/level_1_decrypted_files/level_1_decrypted_file_1.txt');
    // if (originalFileHash == level1DecryptedFileHash) {
    //   print('data encryption and decryption successful');
    // }

    var publicKeyString = await getPublicKeyAsString('${appSupportDir.path}/cryptographic_documents/asymmetric_key_pairs/asymmetric_key_pair_1/public_key.pem');
